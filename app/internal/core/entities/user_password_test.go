...
type userPasswordTestCase struct {
	name  string
	input string
	err   error
}

var userPasswordTestCases = []userPasswordTestCase{
	{
...
type userSetPasswordTestCase struct {
	userPasswordTestCase
	initialValue string
}

var userSetPasswordTestCases = []userSetPasswordTestCase{
	{
		userPasswordTestCase: userPasswordTestCase{
			name:  "empty email should return nil and error",
			input: "",
			err:   errdefs.ErrEmailInvalid,
		},
	...
	{
		userPasswordTestCase: userPasswordTestCase{name: "invalid email should return nil and error",
			input: "johndoe",
			err:   errdefs.ErrEmailInvalid,
		},
		initialValue: "johndoe@example.com",
