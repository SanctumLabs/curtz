...
// ErrPermanentlyFailed signals that the requested action has failed permanently and should not be retried.
// When an ErrPermanentlyFailed is returned, the caller should never retry the action.
type ErrPermanentlyFailed interface {
	PermanentlyFailed()
}
